...
public class MedicationServiceImpl implements MedicationService {
    ...
    @Override
    public List<MedicationResponse> getAllMedications(long medicationId) {
        return medicationFiegn.getAllMedications();
    }

    @Override
    public List<MedicationResponse> getMedicationsByAid(long aid) {
        return medicationFiegn.getAllMedicationsByAid(aid);
    }

    @Override
    public MedicationResponse getMedicationByAid(long aid) {
        return medicationFiegn.getByAid(aid);
    }
    ...
    @Override
    public MedicationResponse getMedicationByDid(long did) {
        return medicationFiegn.getMedicationByDid(did);
    }
