...
public class MedicationServiceImpl implements MedicationService {
    ...
    @Override
    public Medication getMedicationsByAid(long aid) {
        Medication medications = medicationRepository.findByAid(aid);
        return medications;
    }

    @Override
    public Medication getMedicationByDid(long did) {
        Medication medicationByDid = medicationRepository.findMedicationByDid(did);
        return medicationByDid;
    }
}