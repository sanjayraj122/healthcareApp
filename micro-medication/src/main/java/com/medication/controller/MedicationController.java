...
public class MedicationController {
    ...
    @GetMapping("/getMedicationById/{medicationId}")
    ...
    @GetMapping("/getMedicationsByAid/{aid}")
    public ResponseEntity<Medication>getAllMedicationsByAid(@PathVariable long aid) {
        Medication medications = medicationService.getMedicationsByAid(aid);
        return new ResponseEntity<>(medications, HttpStatus.OK);
    }

    @GetMapping("/getMedicationByDid/{did}")
    public ResponseEntity<Medication> getMedicationByDid(@PathVariable long did){
        Medication medicationByDid = medicationService.getMedicationByDid(did);
        return new ResponseEntity<>(medicationByDid,HttpStatus.OK);
    }
}